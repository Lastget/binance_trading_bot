...
if __name__ == '__main__':
    ...
    if status:
        ...
        if account['canTrade']:
            ...
            # strategy_one(timeframe="1h", percentage_rise=0.5, quote_asset="BUSD", project_settings=project_settings, sell_timeframe='30m' , percent_sell_rise=10)
            logging.info('--------- Start Strategy 2 ---------')
            strategy_two(timeframe="1h", percentage_rise=5, quote_asset="BUSD", project_settings=project_settings, sell_timeframe='30m' , percent_sell_rise=2)
